...
import rgb_resnet50 as rgb_net
import pose_RC3D18 as pose_net
import opf_resnet50 as opf_net
...
class ResNet3D():
    ...
    def build_model(self):
        ...
        self.model = Fusion_net(
            RGB_weight='/home/ubuntu/cvlab/pytorch/PennAction_pose_stream/TSN_rgb/record/model_best.pth.tar',
            OPF_weight = '/home/ubuntu/cvlab/pytorch/PennAction_pose_stream/opf_stream/L10_87/model_best.pth.tar',
            Pose_weight='/home/ubuntu/cvlab/pytorch/PennAction_pose_stream/bbox_resnet3d/record/L15/pose3d_L15_91.pth.tar'
        ).cuda()
        #print self.model
        #Loss function and optimizer
        self.criterion = nn.CrossEntropyLoss().cuda()
        parameter = itertools.chain(
            self.model.Rnet1.parameters(),
            self.model.Rnet2.parameters(), 
            self.model.fusion_Linear.parameters(),
            self.model.fusion_conv.parameters()
        )

        self.optimizer = torch.optim.SGD(parameter, self.lr, momentum=0.9)
        #self.optimizer = torch.optim.Adam(parameter, self.lr)
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            if is_best:
                ...
                with open('record/3d_pose_video_preds.pickle','wb') as f:
...
class Fusion_net(nn.Module):
    def __init__(self, RGB_weight, Pose_weight, OPF_weight):
        ...
        self.RGBnet = self.load_weight(rgb_net.resnet50(channel=3), RGB_weight)
