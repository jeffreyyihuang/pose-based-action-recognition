...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, nb_classes=101, channel=20, extract_feature=False):
        self.inplanes = 64
...
def resnet18(pretrained=False, channel=3, nb_classes=15, **kwargs):
...
def resnet34(pretrained=False, channel=3, nb_classes=15, **kwargs):
...
def resnet50(pretrained=False, channel=3, nb_classes=15, **kwargs):
...
def resnet101(pretrained=False, channel=3, nb_classes=15, **kwargs):
